...
var Main = function () {
    ...
    _createClass(Main, [{
        ...
        //     })
        //
        //     let $elements = $('.sm-block-top')
        //
        //     $elements.each( function(){
        //
        //         let $element = $(this)
        //
        //         let triggerHook = $element.attr('data-start') ? Number($element.attr('data-start')) : 0.7
        //
...
var App = function () {
    ...
    _createClass(App, [{
        ...
        key: "watcherGyroscope",
        value: function watcherGyroscope() {
            var t = this;
        ...
        key: "animGyroscope",
        value: function animGyroscope(e) {
            var t = this;

            var x = e.accelerationIncludingGravity.x;
            var y = e.accelerationIncludingGravity.y + 6;

            TM.to(t.$strokes, 0.3, { x: x, y: y, ease: Quad.easeOut });
        }
    }], [{
        key: "quickActions",
