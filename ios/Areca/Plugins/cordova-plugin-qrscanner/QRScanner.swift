...
//                // ici old : AVMetadataObjectTypeQRCode
...
//        if found.type == AVMetadataObject.ObjectType.face && found.stringValue != nil {
//            scanning = false
...
//        if(backCamera?.hasTorch == true && backCamera?.isTorchAvailable == true){
//            canEnableLight = true
//        }
//
